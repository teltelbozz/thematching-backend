...
exports.enqueueLineNotificationsForSlot = enqueueLineNotificationsForSlot;
exports.enqueueLineNotificationsForGroup = enqueueLineNotificationsForGroup;
const FRONT_ORIGIN = (process.env.FRONT_ORIGIN || "https://thematching-frontend.vercel.app").replace(/\/+$/, "");
 ...
 */
async function enqueueLineNotificationsForSlot(pool, slotDt) {
 ...
 */
async function enqueueLineNotificationsForGroup(client, groupId, token) {
